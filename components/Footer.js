...
function Footer() {
    ...
    return (
        <footer className={styles.footer + ' back'}>
            ...
            <a className={styles.developedBy} href="https://jedai.az/az/saytlarin-hazirlanmasi" target='blank'><p className='text'>Site by</p>  <img width='107.22px' height='20px' src="/jedai-logo.png" alt="" /></a>
        </footer>
    )
}
