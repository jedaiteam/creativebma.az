            ...
            <div className={styles.aboutPage + " page"}>
                ...
                <div className={styles.aboutPart1}  data-aos="fade-up">
                    <p className={styles.text + ' text'}> 
                        {langM === "AZ" && `"Creative Spark" Birləşmiş Krallığın dəstəyilə Mərkəzi Asiya ölkələrində, Cənubi Qafqaz
ölkələrində və Ukraynada biznes bacarıqlarını və yaradıcı iqtisadiyyatı inkişaf etdirmək
məqsədilə universitetlərarası və institusional əməkdaşlığı beynəlxalq səviyyədə
dəstəkləmək üçün nəzərdə tutulan beş illik təşəbbüsdür.` 
