    ...
    <div  className={styles.homepage} >
        ...
        <div className={styles.enterance}>
            <div className={styles.enteranceText}>
                <h1 className={styles.titleTop + " title-big-desk"}>{langM === "AZ" && `Creative Spark` || langM === "EN" && `Creative Spark` || langM === "RU" && `Креативе Спарк`}</h1>
        ...
        <div className={styles.aboutPart}>
          ...
          <div className={styles.aboutText}>
            ...
            <Link href="/about"><button className={stylesBtn.buttonEffect + " button-text"}>{langM === "AZ" && `Daha ətraflı` || langM === "EN" && `More About` || langM === "RU" && `Читать далее`}</button></Link>
          </div>
        </div>
        ...
        <div className={styles.partnersPart}>
          ...
          <Link href="/partners"><button className={stylesBtn.buttonEffect + " button-text"}>{langM === "AZ" && `Daha ətraflı` || langM === "EN" && `More About` || langM === "RU" && `Читать далее`}</button></Link>
        </div>
        ...
        <div className={styles.studentsPart}>
          ...
          <Link href="/students"><button className={stylesBtn.buttonEffect + " button-text"}>{langM === "AZ" && `Daha ətraflı` || langM === "EN" && `More About` || langM === "RU" && `Читать далее`}</button></Link>
        </div>
        ...
        <div className={styles.bmaPart}>
          <div className={styles.bmaText}>
            ...
            <Link href="/staff"><button className={stylesBtn.buttonEffect + " button-text"}>{langM === "AZ" && `Daha ətraflı` || langM === "EN" && `More About` || langM === "RU" && `Читать далее`}</button></Link>
          </div>
        ...
        <h2 className='title-b-desk'>{langM === "AZ" && `Xəbərlər` || langM === "EN" && `News` || langM === "RU" && `Новости`}</h2>
          <div className={styles.newsElements}>
            {news3.map(news => <News title={news.title} content={news.content} image={news.img}/>)}
          </div>
          <Link href="/news"><button className={stylesBtn.buttonEffect + " button-text"}>Daha ətraflı</button></Link>
        </div>
