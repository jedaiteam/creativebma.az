                ...
                <div className={styles.linksAndImg}>
                    <div className={styles.links} data-aos="fade-right">
                        <div  className={styles.part1 + " mt30 text"}>
                            ...
                            <a href='mailto:international_dpt@musicacademy.edu.az' data-aos="fade-right" ><img src="/Message.png" alt="instagram-logo"/>{langM === "AZ" && ` international_dpt@musicacademy.edu.az` || langM === "EN" && ` international_dpt@musicacademy.edu.az` || langM === "RU" && ` international_dpt@musicacademy.edu.az`}</a>
                            <a href='https://www.google.com/maps/place/98+%D1%83%D0%BB.+%D0%A8%D0%B0%D0%BC%D1%81%D0%B8+%D0%91%D0%B0%D0%B4%D0%B0%D0%BB%D0%B1%D0%B5%D0%B9%D0%BB%D0%B8,+Baku/data=!4m2!3m1!1s0x40307da7b536bd7b:0xf752205a661abf77?sa=X&ved=2ahUKEwjCl6my06jwAhXGg_0HHRqJDWoQ8gEwAHoECAYQAQ' data-aos="fade-right" ><img src="/Location.png"  alt="instagram-logo"/>{langM === "AZ" && `Şəmsi Bədəlbəyli küçəsi, Bakı, Azərbaycan` || langM === "EN" && `Baku, Azerbaijan , Shamsi Badalbeyli Street` || langM === "RU" && `г. Баку, ул. Шамси Бадалбейли`}</a>
                            <a href='https://www.instagram.com/baki_musiqi_akademiyasi/' data-aos="fade-right" ><img src="/instagram.png" alt="instagram-logo"/> <span> baki_musiqi_akademiyasi </span></a>
                            <a href='https://m.facebook.com/baku.music.academy/' data-aos="fade-right" ><img src="/facebook.png" alt="facebook-logo"/> <span>baku.music.academy</span></a>
                        </div>
                    </div>
